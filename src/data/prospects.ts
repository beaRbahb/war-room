...
export const PROSPECTS: Prospect[] = [
  ...
  },
  {
    ...
    height: "6'0\"", weight: 230, age: 21,
    proComp: "Zaire Franklin",
    note: "First-team All-American, Butkus Award finalist. Dependable 'green dot' Mike LB who raises the floor of a defense. Effective blitzer, capable on all three downs. More steady than splash.",
  },
  {
    rank: 36, name: "Colton Hood", position: "CB", college: "Tennessee",
    height: "5'11\"", weight: 193, age: 21,
    proComp: "Carlton Davis III",
    note: "Press-man bully with stopping power in run support. Disruptive punch at the line, physical in catch space. Needs to sharpen technique vs twitchy releases.",
  },
  {
    rank: 37, name: "Zion Young", position: "EDGE", college: "Missouri",
    height: "6'5\"", weight: 262, age: 23,
    proComp: "Za'Darius Smith",
    note: "Fiery alpha — immense energy on field and in locker room. Block destruction via base power and aggression. Instant run-stopping upgrade. Needs go-to rush moves and counters.",
  },
  {
    rank: 38, name: "Caleb Banks", position: "DL", college: "Florida",
    height: "6'6\"", weight: 327, age: 23,
    proComp: "Gervon Dexter Sr.",
    note: "Big-framed interior defender with quick first step. Traits waiting to be unlocked — enticing Senior Bowl flashes. Injury concerns (foot surgery) a stumbling block.",
  },
  {
  ...
  },
  {
    ...
    proComp: "Josh Sweat",
    note: "Prototypical size with suddenness of a smaller player. Explosive get-off, deep bag of moves/counters. Ascending prospect with rush polish. Must improve run-support consistency.",
  },
  {
    rank: 44, name: "Jacob Rodriguez", position: "LB", college: "Texas Tech",
    height: "6'1\"", weight: 231, age: 23,
    proComp: "Carson Schwesinger",
    note: "Won Nagurski, Lombardi, Bednarik & Butkus awards. 5th in Heisman voting. Elite production: 13 career FFs, FBS-leading 7 in 2025. Ballhawk instincts with occasional coverage busts.",
  },
  {
    rank: 45, name: "Jadarian Price", position: "RB", college: "Notre Dame",
    height: "5'10\"", weight: 203, age: 22,
    proComp: "Javonte Williams",
    note: "Tempo-driven back with elite vision and a nose for the end zone. Smooth hips, rare path-finding instincts. Limited third-down value caps draft slot. Excellent complementary back.",
  },
  {
    rank: 46, name: "Christen Miller", position: "DL", college: "Georgia",
    height: "6'3\"", weight: 321, age: 22,
    proComp: "Christian Wilkins",
    note: "Even-front nose tackle who rattles pads at the point of attack. Good stack-and-shed against single blocks. Lacks space-eater mass but projects as solid starter — more consistent than dominant.",
  },
  {
    rank: 47, name: "R Mason Thomas", position: "EDGE", college: "Oklahoma",
    height: "6'2\"", weight: 241, age: 23,
    proComp: "Dee Ford",
  ...
  { rank: 53, name: "Chris Bell", position: "WR", college: "Louisville" },
  {
    ...
    height: "6'4\"", weight: 239, age: 23,
    proComp: "Malik Harrison",
    note: "Big, explosive LB best suited near the line. Attacks blocks with heavy, aggressive hands. Average in coverage. Early special teams standout with starting potential at Sam or ILB.",
  },
  {
    rank: 55, name: "Chris Brazzell", position: "WR", college: "Tennessee",
    height: "6'4\"", weight: 198, age: 22,
    proComp: "Christian Watson",
    note: "Long-limbed Z receiver with downfield explosion. Dominates above the rim with size and body control. 6-177-3 TDs vs Georgia in 2025. Quick-strike vertical threat.",
  },
  ...
  { rank: 62, name: "Zachariah Branch", position: "WR", college: "Georgia" },
  {
    ...
    height: "6'3\"", weight: 255, age: 23,
    proComp: "Yaya Diaby",
    note: "Bull-rush aficionado who piles up pressures and sacks (10 in 2025). Strong through top of rush. Needs more urgency as run defender. Starter capable of racking up pressures.",
  },

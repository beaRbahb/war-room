...
export const PROSPECTS: Prospect[] = [
  ...
  {
    rank: 5, name: "Francis Mauigoa", position: "OT", college: "Miami (FL)",
  ...
  {
    rank: 6, name: "Sonny Styles", position: "LB", college: "Ohio State",
  ...
  {
    rank: 7, name: "Carnell Tate", position: "WR", college: "Ohio State",
  ...
  {
    rank: 8, name: "Rueben Bain", position: "DL", college: "Miami (FL)",
  ...
  {
    rank: 9, name: "Caleb Downs", position: "S", college: "Ohio State",
  ...
  {
    rank: 10, name: "Mansoor Delane", position: "CB", college: "LSU",
  ...
  {
    rank: 11, name: "Spencer Fano", position: "OT", college: "Utah",
  ...
  {
    rank: 12, name: "Monroe Freeling", position: "OT", college: "Georgia",
  ...
  {
    rank: 13, name: "Makai Lemon", position: "WR", college: "USC",
  ...
  {
    rank: 14, name: "Jermod McCoy", position: "CB", college: "Tennessee",
  ...
  {
    rank: 15, name: "Jordyn Tyson", position: "WR", college: "Arizona State",
  ...
  {
    rank: 16, name: "Olaivavega Ioane", position: "IOL", college: "Penn State",
  ...
  {
    rank: 17, name: "Kenyon Sadiq", position: "TE", college: "Oregon",
  ...
  {
    rank: 18, name: "Dillon Thieneman", position: "S", college: "Oregon",
  ...
  {
    rank: 19, name: "Kadyn Proctor", position: "OT", college: "Alabama",
  ...
  {
    rank: 21, name: "Akheem Mesidor", position: "EDGE", college: "Miami (FL)",
  ...
  {
    rank: 22, name: "Omar Cooper Jr.", position: "WR", college: "Indiana",
  ...
  {
    rank: 23, name: "Emmanuel McNeil-Warren", position: "S", college: "Toledo",
  ...
  {
    rank: 24, name: "Blake Miller", position: "OT", college: "Clemson",
  ...
  {
    rank: 25, name: "Caleb Lomu", position: "OT", college: "Utah",
  ...
  {
    rank: 26, name: "Kevin Concepcion", position: "WR", college: "Texas A&M",
  ...
  {
    rank: 27, name: "Avieon Terrell", position: "CB", college: "Clemson",
  ...
  {
    rank: 30, name: "Denzel Boston", position: "WR", college: "Washington",
  ...
  {
    rank: 31, name: "Kayden McDonald", position: "DL", college: "Ohio State",
  ...
  {
    rank: 36, name: "Max Iheanachor", position: "OT", college: "Arizona State",
    height: "6'6\"", weight: 321, age: 22, ras: 9.86,
    proComp: "Taylor Moton",
    note: "The 'dancing bear.' Native of Nigeria, started playing football in 2021. Sweet feet. Dominant Senior Bowl.",
  },

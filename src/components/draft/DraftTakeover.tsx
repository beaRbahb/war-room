...
export default function DraftTakeover({ onComplete }: DraftTakeoverProps) {
  ...
  return (
    <div className="fixed inset-0 z-[95] bg-bg flex flex-col items-center justify-center min-h-dvh">
      <h1 className="font-display text-5xl sm:text-7xl text-amber tracking-wider animate-pulse otc-title">
        THE DRAFT IS LIVE
      </h1>
